    ...
    properties: [
      {
        ...
        type: 'options',
        options: [
          { name: '01. Octagon Agent (Router)', value: 'octagon-agent', description: 'Intelligent agent router that analyzes queries and routes to specialized agents' },
          { name: '02. SEC Agent', value: 'octagon-sec-agent', description: 'Public market intelligence - Analyzes SEC filings and public company disclosures' },
          { name: '03. Transcripts Agent', value: 'octagon-transcripts-agent', description: 'Public market intelligence - Analyzes earnings call transcripts' },
          { name: '04. Stock Data Agent', value: 'octagon-stock-data-agent', description: 'Public market intelligence - Provides real-time and historical stock market data' },
          { name: '05. Holdings Agent', value: 'octagon-holdings-agent', description: 'Public market intelligence - Analyzes institutional holdings data' },
          { name: '06. Financials Agent', value: 'octagon-financials-agent', description: 'Public market intelligence - Analyzes financial statements' },
          { name: '07. Crypto Agent', value: 'octagon-crypto-agent', description: 'Public market intelligence - Analyzes cryptocurrency market data' },
          { name: '08. Companies Agent', value: 'octagon-companies-agent', description: 'Private market intelligence - Provides private company information' },
          { name: '09. Funding Agent', value: 'octagon-funding-agent', description: 'Private market intelligence - Analyzes private company funding data' },
          { name: '10. Funds Agent', value: 'octagon-funds-agent', description: 'Private market intelligence - Analyzes investment funds and fund managers' },
          { name: '11. Deals Agent', value: 'octagon-deals-agent', description: 'Private market intelligence - Analyzes M&A and IPO data' },
          { name: '12. Investors Agent', value: 'octagon-investors-agent', description: 'Private market intelligence - Analyzes venture capital and private equity investors' },
          { name: '13. Debts Agent', value: 'octagon-debts-agent', description: 'Private market intelligence - Analyzes private debts, borrowers, and lenders' },
          { name: '14. Scraper Agent', value: 'octagon-scraper-agent', description: 'Deep research intelligence - Scrapes and analyzes web content' },
          { name: '15. Deep Research Agent', value: 'octagon-deep-research-agent', description: 'Deep research intelligence - Conducts in-depth research' },
        ],
